...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = -1624698814L;

    public static final QAlbum album = new QAlbum("album");

    public final QItemEntity _super = new QItemEntity(this);

    public final StringPath artist = createString("artist");

    //inherited
    public final ListPath<CategoryEntity, QCategoryEntity> categoryEntities = _super.categoryEntities;
